function [violationFraction, out_bounds] = nonviolationfraction(pwr_case, pv_cap, irrad_time,...
    pct_load, options, storageCap, storageBus, numBuses, pvBus, withStorage, verbose)
...
currentStorageLoad = storageCap/2;
specialViolations = 0;
...
%     fprintf('Current Number of Violations: %d\n', out_bounds);
    ...
    temp_case.bus(2,3) = temp_case.bus(2,3) - pct_flux*5;
